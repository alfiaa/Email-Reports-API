...
class PostData{
      ...
      private $headerlogo;
      private $subclass_mainbody;
      private $subclass_restofform;
      private $subclass_mainphotos;
      private $profile;
      private $record_info;
      private $record_id; 
  ...
  */
  public function recursiveRemoval(&$array, $val)
  {
    ...
    */
    ...
    {
      $mainform_body= $this->subclass_mainbody;
    }
    ...
    if(!empty($this->report_photos))
    {
     ...
     $mainphotos_body="";
    if(empty($mainphotos)&&!empty($this->subclass_mainphotos))
    {
        $mainphotos = $this->subclass_mainphotos;
    }
     if(!empty($mainphotos))
    {
