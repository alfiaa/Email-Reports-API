...
class PostData_line_inspections{
	...
	*/
	...
	public function __get($name)
	{
      ...
      public function setRecipients()
      {
		     ...
		     /*  $this->recipients = "vinodr@thinkpowersolutions.com,alfiaa@thinkpowersolutions.com";
          ...
          {      
            ...
            elseif(strpos($this->formtitle, 'Line Construction Inspection') !== false)
            {
                ...
                elseif(strpos($this->subformtitle, 'Pole Jacking Assessment')!== false || strpos($this->subformtitle, 'Structure Erection Assessment')!== false)
                {
                 ...
                 elseif(strpos($this->subformtitle, 'Pulling Operation Assessment')!== false 
                        || strpos($this->subformtitle, 'Sagging Operation Assessment')!== false
                        || strpos($this->subformtitle, 'Stringing Operation Assessment')!== false
            ...
            }elseif(strpos($this->formtitle, 'ROW Assessment') !== false || strpos($this->subformtitle, 'Permit Assessment')!== false) 
            {
  ...
  public function recursiveRemoval(&$array, $val)
  {
    ...
    */
    public function prepareMainform()
    {
        ...
        $main_form_keys = array("form_title","field_employee","circuit","report_date","client","project_manager","electrical_engineer","gps_latitude","gps_longitude","project_wo","onsite_contractor","weather_conditions");
									  ...
									  <td class='col inner' width='298' style='padding:2px 4px;padding: 10px;'>
										<table cellpadding='0' cellspacing='0' style='border-spacing:0;width:100%;display:block;'>
										  ...
										  <tr>
											...
											<td style='padding:2px 4px;width:70%;'>{$mainform['circuit']}</td>
										  </tr>
                                          <tr>
