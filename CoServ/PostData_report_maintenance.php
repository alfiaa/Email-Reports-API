...
class PostData_report_maintenance{
  ...
  public function recursiveRemoval(&$array, $val)
  {
    ...
    */
    public function prepareMainform()
    {
        ...
        $main_form_keys = array("form_title","field_employee","company","crew_no","work_date","gps_latitude","gps_longitude","weather_conditions");
