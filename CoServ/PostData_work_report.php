  ...
  public function recursiveRemoval(&$array, $val)
  {
    ...
    */
    public function prepareMainform()
    {
        ...
        $main_form_keys = array("form_title","field_employee","company","work_date","work_type","vm_area","job_no","cycle_no","crew_no","gps_latitude","gps_longitude","weather_conditions");
									...
									<tr>
									  <td class='col inner' width='298' style='padding:2px 4px;padding: 10px;'>
										<table cellpadding='0' cellspacing='0' style='border-spacing:0;width:100%;display:block;'>
										  <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>Field Employee </td>
											<td style='padding:2px 4px;width:70%;'>{$mainform['field_employee']}</td>
										  </tr>
										  <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>Company</td>
											<td style='padding:2px 4px;width:70%;'>{$mainform['company']}</td>
										  </tr>
                                          <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>Work Date</td>
											<td style='padding:2px 4px;width:70%;'>{$mainform['work_date']}</td>
										  </tr>
                                           <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>Crew No.</td>
											<td style='padding:2px 4px;width:70%;'> {$mainform['crew_no']}</td>
										  </tr>
										</table>
									  </td>
									  ...
									  <td class='col inner' width='298' style='padding:2px 4px;padding: 10px;'>
										<table cellpadding='0' cellspacing='0' style='border-spacing:0;width:100%;display:block;'>
										  <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>VM Work Type	</td>
											<td style='padding:2px 4px;width:70%;'>{$mainform['work_type']}</td>
										  </tr>
										  <tr>
										  ...
										  <tr>
                                           ...
                                           <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>Cycle No.</td>
											<td style='padding:2px 4px;width:70%;'> {$mainform['cycle_no']}</td>
										  </tr>
										</table>
									  </td>
									</tr>
