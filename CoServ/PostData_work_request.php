    ...
    public function createPDF()
      ...
      **/
      ...
      public function setErrorMessage($data)
      {
          ...
          $report_date = $data['request_date'];
          $project = $data['vm_area'];
         $form_title = $data['form_title'];
          $this->record_info = 'Profile: '.$this->profile. ' Form Title: '.$form_title.' VM Area: '.$project.' Employee: '. $employee. ' Record id : '.$this->record_id.' Request Date '.$report_date.'<br/>';
      }
  ...
  public function recursiveRemoval(&$array, $val)
  {
    ...
    */
    public function prepareMainform()
    {
        ...
        $main_form_keys = array("form_title","field_employee","request_date","request_type","vm_area","job_no","assigned_company","gps_latitude","gps_longitude","weather_conditions");
									...
									<tr>
									  <td class='col inner' width='298' style='padding:2px 4px;padding: 10px;'>
										<table cellpadding='0' cellspacing='0' style='border-spacing:0;width:100%;display:block;'>
										  ...
										  <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>Request Date</td>
											<td style='padding:2px 4px;width:70%;'>{$mainform['request_date']}</td>
										  </tr>
                                          <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>VM Request Type</td>
											<td style='padding:2px 4px;width:70%;'>{$mainform['request_type']}</td>
										  </tr>
										</table>
									  </td>
									  ...
									  <td class='col inner' width='298' style='padding:2px 4px;padding: 10px;'>
										<table cellpadding='0' cellspacing='0' style='border-spacing:0;width:100%;display:block;'>
										  <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>VM Area	</td>
											<td style='padding:2px 4px;width:70%;'>{$mainform['vm_area']}</td>
										  </tr>
										  <tr>
