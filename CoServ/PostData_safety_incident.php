...
class PostData_safety_incident{
...
public function createPDF()
      ...
      **/
      ...
      public function setErrorMessage($data)
      {
          ...
          $employee = $data['reporting_employee'];
          $report_date = $data['incident_datetime'];
          $project = $data['incident_company'];
           $form_title = $data['form_title'];
          $this->record_info = 'Profile: '.$this->profile.' Form Title: '.$form_title.' incident_company: '.$project.' Employee: '. $employee. ' Record id : '.$this->record_id.' incident_datetime'.$report_date.'<br/>';
      }
  ...
  public function recursiveRemoval(&$array, $val)
  {
    ...
    */
    public function prepareMainform()
    {
        ...
        $main_form_keys = array("form_title","reporting_employee","incident_company","incident_work_area","incident_crew","incident_datetime","incident_type","incident_severity","gps_latitude","gps_longitude","weather_conditions");
									...
									<tr>
									  <td class='col inner' width='298' style='padding:2px 4px;padding: 10px;'>
										<table cellpadding='0' cellspacing='0' style='border-spacing:0;width:100%;display:block;'>
										  <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>Reporting Employee </td>
											<td style='padding:2px 4px;width:70%;'>{$mainform['reporting_employee']}</td>
										  </tr>
										  <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>Incident Company</td>
											<td style='padding:2px 4px;width:70%;'>{$mainform['incident_company']}</td>
										  </tr>
                                           <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>Incident Crew</td>
											<td style='padding:2px 4px;width:70%;'>{$mainform['incident_crew']}</td>
										  </tr>
                                          <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>Incident Date	</td>
											<td style='padding:2px 4px;width:70%;'>{$mainform['incident_datetime']}</td>
										  </tr>
									  ...
									  <td class='col inner' width='298' style='padding:2px 4px;padding: 10px;'>
										<table cellpadding='0' cellspacing='0' style='border-spacing:0;width:100%;display:block;'>
										   <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'>Incident Work Area</td>
											<td style='padding:2px 4px;width:70%;'> {$mainform['incident_work_area']}</td>
										  </tr>
										  ...
										  <tr>
											...
											<td style='padding:2px 4px;width:70%;'>
											 {$mainform['incident_severity']}
															</td>
										  </tr>
                                           <tr>
											<td class='strong' style='padding:2px 4px;font-weight:800;width:30%;'></td>
											<td style='padding:2px 4px;width:70%;'> &nbsp;</td>
										  </tr>
										</table>
									  </td>
									</tr>
